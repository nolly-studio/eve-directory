...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card shadow-surface flex flex-col gap-(--card-spacing) overflow-hidden rounded-xl bg-card py-(--card-spacing) text-body text-card-foreground transition-[box-shadow,background-color] duration-200 [--card-spacing:--spacing(5)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-heading-24 font-semibold text-balance text-gray-1000",
        className
      )}
      {...props}
    />
